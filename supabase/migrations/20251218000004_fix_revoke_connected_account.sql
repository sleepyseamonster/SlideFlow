/*
  Fix revoke_connected_account RPC argument name & ambiguity

  - Restores the parameter name to account_id so client RPC calls align.
  - Qualifies columns to avoid "column reference ... is ambiguous" errors.
*/
...
begin
  ...
  where cas.account_id = account_id;
