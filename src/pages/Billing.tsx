...
import { ArrowLeft, Sparkles, CreditCard, Clock, Download, Info, ShieldCheck, Heart } from 'lucide-react';
    ...
    <div className="min-h-screen bg-ink text-vanilla">
      ...
      <main className="pt-20 pb-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="space-y-2">
            ...
            <div>
              ...
              <p className="text-vanilla/70">
                Calm, factual status. No surprise charges, no pressure.
              </p>
            </div>
          </div>

          {/* Status Anchor */}
          <section className="sf-card p-7 bg-surface-alt/85 border border-charcoal/60 space-y-5">
          ...
          {/* Usage & Credits */}
          <section className="sf-card p-6 bg-surface/80 border border-charcoal/60 space-y-4">
          ...
          {/* Limits, Rhythm, Guarantees */}
          <section className="sf-card p-6 bg-surface/75 border border-charcoal/60 space-y-3">
          ...
          {/* Credit Packs */}
          <section id="credit-packs" className="sf-card p-6 bg-surface/70 border border-charcoal/60 space-y-4">
          ...
          {/* How Billing Works */}
          <section className="sf-card p-6 bg-surface/80 border border-charcoal/60 space-y-3">
          ...
          {/* Billing History */}
          <section className="sf-card p-6 space-y-4 bg-surface/75 border border-charcoal/60">
            <div className="flex items-center justify-between">
              <div>
